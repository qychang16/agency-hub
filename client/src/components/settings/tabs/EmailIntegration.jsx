          ...
          <Card>
            ...
            {[
              ...
              <div key={m.value} onClick={() => setSendMode(m.value)}
                style={{ display: 'flex', gap: 10, padding: '10px 12px', borderRadius: 8, border: `1.5px solid ${sendMode === m.value ? ACCENT : '#dcd8d0'}`, marginBottom: 8, cursor: 'pointer', background: sendMode === m.value ? ACCENT_LIGHT : '#fff' }}>
                <div style={{ width: 16, height: 16, borderRadius: '50%', border: `2px solid ${sendMode === m.value ? ACCENT : '#c2bdb3'}`, background: sendMode === m.value ? ACCENT : '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 2 }}>
              ...
              {[
                ...
                <div key={item.label} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 0', borderBottom: '0.5px solid #faf9f7' }}>
                  ...
                  <button disabled={item.locked}
                    style={{ width: 44, height: 24, borderRadius: 12, border: 'none', background: item.enabled ? ACCENT : '#c2bdb3', cursor: item.locked ? 'not-allowed' : 'pointer', position: 'relative' }}>
